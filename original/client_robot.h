...
#define SECOND_SERVO 16     
#define THIRD_SERVO 20      
#define FOURTH_SERVO 26     
#define GRIPPER 19
#define PORT 8443
...
void gripper_ninety(void);
void gripper_oneeighty(void);
void spin_ninety4(void);
void spin_oneeighty4(void);
void spin_ninety3(void);
void spin_oneeighty3(void);
void spin_ninety2(void);
void spin_oneeighty2(void);
